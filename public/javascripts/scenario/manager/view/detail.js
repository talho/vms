...
Talho.VMS.Scenario.Manager.View.Detail = Ext.extend(Ext.Panel, {
  ...
  initComponent: function(){
    ...
    this.items = [
      {xtype: 'container', padding: '5', layout: 'form', items:[
        ...
        {xtype: 'button', hideLabel: true, text: 'Edit Scenario Details', scope: this, handler: function(){this.fireEvent('edit', this.record);} }
      ]}
    ]
