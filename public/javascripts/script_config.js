...
Talho.ScriptManager.addInitializer('Talho.VMS.CommandCenter', {js:'$(ext_extensions)/DoNotCollapseActive.js $(ext_extensions)/GMapPanel.js Site Roles Inventory Staff Teams Qualifications $(vms)/command_center.js'});
