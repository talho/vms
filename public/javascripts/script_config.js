...
Talho.ScriptManager.addInitializer('Talho.VMS.CommandCenter', {js:'$(ext_extensions)/DoNotCollapseActive.js $(ext_extensions)/GMapPanel.js UserSelectionGrid Site Roles Inventory $(vms)/item_detail_windows.js $(vms)/command_center.js'});
