...
dominoes.rule('VMS_User_Profile_Views', '$(vms)/extensions/column_panel.js $(vms)/user/profile/view/alerts.js $(vms)/extensions/action_button.js $(vms)/user/profile/view/alert_detail.js $(ext_extensions)/xActionColumn.js $(vms)/user/profile/view/qualifications.js');
...
dominoes.rule('VMS_Volunteer_List_Views', '$(vms)/extensions/column_panel.js > $(vms)/extensions/action_button.js $(vms)/volunteer/list/view/column_panel.js $(vms)/volunteer/list/view/list_actions.js $(vms)/volunteer/list/view/alert.js $(vms)/volunteer/list/view/list.js $(vms)/volunteer/list/view/new_status_check.js $(vms)/volunteer/list/view/status_checks.js $(vms)/volunteer/list/view/status_responders.js $(vms)/volunteer/list/view/volunteer_actions.js');
