...
dominoes.rule('VMS_CommandCenter', '( $(vms)/command_center/context_menus.js $(vms)/command_center/site_applications.js $(vms)/command_center/scenario_status.js ) > $(vms)/command_center/command_center.js UserSelectionGrid $(vms)/scenario/status_change.js')
